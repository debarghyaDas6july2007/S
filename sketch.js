...
function preload(){
 ...
 Developer_img = loadImage("Title.png")
...
function setup() {
  ...
  Replay = createSprite(800,400)
  Replay.addImage(Replay_img)

  Play = createSprite(800,500,20,20)
  Play.addImage(Play_img)
  Play.scale = 0.7
   
  Title = createSprite(800,300)
  Title.addImage(Title_img)
  Title.scale = 0.5

  Developer = createSprite(800,400)
...
function handleCollision(enemyGroup){
 ...
 function spawnEnemyShips1(){
   if(frameCount % 60 === 0){
     ...
     var enemy1 = createSprite(1800,y,10,40)
 ...
 function spawnEnemyShips2(){
  if(frameCount % 120 === 0){
    var y= Math.round(random(1250,400))
    var enemy2 = createSprite(1800,y,10,40)
...
function spawnEnemyShips3(){
  if(frameCount % 180 === 0){
    var y= Math.round(random(1300,450))
    var enemy3 = createSprite(1800,y,10,40)
...
function spawnEnemyShips4(){
  if(frameCount % 240 === 0){
    var y= Math.round(random(1350,400))
    var enemy4 = createSprite(1800,y,10,40)
...
function spawnEnemyShips5(){
  if(frameCount % 300 === 0){
    var y= Math.round(random(1400,450))
    var enemy5 = createSprite(1800,y,10,40)
